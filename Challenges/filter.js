...
//const result = presidents.filter(year => year.number > 1899);
//console.log(result)

//let result = presidents.filter(presidents => presidents.year  <= 1900)

let pres1900 = presidents.filter(pres => pres.year <= 1900)
//console.log(pres1900) 
pres1900.forEach(oldPres => console.log(`${oldPres.first}, ${oldPres.last}`))
//presidents.filter(function(pres) {
//    if (pres.year <= 1900) {
//        console.log(pres)
//    }
//})
...
/* 
    Utilize your newly minted array with the presidents born up until the 1900's and use forEach method to console.log() a string interpolated result of their first and last names.
...
// Filter Challenge
/*
Using Array.prototype.filter() method, filter through the presidents array and console.log only the presidents who were born in the 1900's.
*/
